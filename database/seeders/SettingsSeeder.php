...
class SettingsSeeder extends Seeder
{
    ...
    public function getItems()
    {
        return [
            ...
            ["type" => "plugin", "space" => "stripe", "name" => "secret(s)_key", "value" => "sk_test_FlsXnYjhoqLb6d5JzvpgKdMM", "json" => 0],
            ["type" => "plugin", "space" => "stripe", "name" => "test_mode", "value" => "1", "json" => 0],
            ["type" => "plugin", "space" => "paypal", "name" => "sandbox_client_id", "value" => "AYnGaFvGXr3WIkcVL_xeJHjCa4ypZe3mL0cPWYYHzeQgrObCx0qtHd0dvKWuRPc68WHF85obrwZoIpkp", "json" => 0],
            ["type" => "plugin", "space" => "paypal", "name" => "sandbox_secret(s)", "value" => "EAgcYU-K5hLJpxjXotuanZDXK-CZcRTnlUdb4gx3K3CBipCv5l_fTAQPD4FxdJn7GhxuD4UvhaOsiTY8", "json" => 0],
            ["type" => "plugin", "space" => "paypal", "name" => "live_client_id", "value" => "AYnGaFvGXr3WIkcVL_xeJHjCa4ypZe3mL0cPWYYHzeQgrObCx0qtHd0dvKWuRPc68WHF85obrwZoIpkp", "json" => 0],
            ["type" => "plugin", "space" => "paypal", "name" => "live_secret(s)", "value" => "EAgcYU-K5hLJpxjXotuanZDXK-CZcRTnlUdb4gx3K3CBipCv5l_fTAQPD4FxdJn7GhxuD4UvhaOsiTY8", "json" => 0],
